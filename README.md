...
## 🚀 About Me
Soy desarrollador frontend enfocado en construir interfaces claras, rápidas y mantenibles. Actualmente trabajo con Tailwind CSS, JavaScript moderno, Astro y Alpine, mientras exploro Vue.js para aplicaciones reactivas. Mantengo experiencia previa en SCSS y React (legacy), aunque hoy priorizo enfoques más simples y productivos.


## 🛠 Skills

### Stack Actual
[![Icoziv-icons](https://i.icoziv.workers.dev/icons?i=alpinejs-light,astro-light,css,html,javascript,tailwindcss-light,vuejs-light&t=light)](https://i.icoziv.workers.dev)
